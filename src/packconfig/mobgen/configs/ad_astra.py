...
octopus_carcass = "harvestcraft:octopusrawitem"
...
octopus_loot = [Loot("1", octopus_carcass), Loot("1", ink_sac)]
...
octopus = Creature("zawa:octopus", LONER, loot_list=octopus_loot)
